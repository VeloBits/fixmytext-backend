...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_users_keycloak_id', 'users', ['keycloak_id'], schema='auth')
    op.create_index('ix_users_keycloak_id', 'users', ['keycloak_id'], unique=True, schema='auth')
