...
PROMPTS: dict[str, str] = {
    ...
    "emojify": (
        ...
        "For example: 'I am crying' -> 'I am crying-face-emoji', "
        "'boom' -> 'explosion-emoji', "
        "'I love pizza' -> 'I heart-emoji pizza-emoji', "
        "'happy birthday' -> 'cake-emoji party-emoji'. "
    ...
    "redundancy_remover": (
        "You are a concise writing editor. Remove redundant words and phrases from the "
        "user's text. "
