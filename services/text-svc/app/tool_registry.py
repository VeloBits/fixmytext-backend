...
Adding a new local tool requires:
  1. Implementing the function in ``app.services.text_service``.
  2. Adding a ``_register(...)`` call in ``_register_all_tools()`` below.
"""
...
class ToolType(StrEnum):
    """Only LOCAL tools are served by text-svc."""
...
class ToolDefinition:
    ...
    Attributes:
        ...
        handler: The sync function from ``text_service``.
        tool_type: Always LOCAL for this service.
...
# ---------------------------------------------------------------------------
# Registration of every LOCAL tool
# ---------------------------------------------------------------------------


def _register_all_tools() -> None:  # noqa: C901 -- unavoidably long
    """Register every local tool."""
    import binascii
